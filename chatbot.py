...
class Connection(Client):
    ...
    def apiaiCon(self):
        self.CLIENT_ACCESS_TOKEN = "9647c532f9324226a9c9a7916f53eba5"
    ...
    def onMessage(self, author_id=None, message_object=None, thread_id=None, thread_type=ThreadType.USER, **kwargs):
        ...
        # Convert json obect to a list, for python 3.6 replace json.load(reader(response)) with json.load(response)
